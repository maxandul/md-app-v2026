...
def employee(number: str, first: str, last: str, *, position: str, entry: str = "2020-01-01", exit_date: str = "", probation: str = "") -> dict:
    return {
        ...
        "no_md_reason": "",
        "no_md_note": "",
        "suggestion": {"scope": "full", "reason": "Regulärer jährlicher Mitarbeitenden-Dialog"},
        "dialog_date": "",
...
def complete_review(item: dict, *, rating: str = "B – sehr gut", agreement: str = "Ja") -> None:
    ...
    item["review"].update({
        ...
        "agreement": agreement,
        "secondary_employment_current": "Keine Angaben vorhanden",
    })
...
def build_demo() -> dict:
    ...
    celine["scope"] = "outlook_only"
    celine["scope_reason"] = "Probezeit abgeschlossen; für 2025 ist nur der Ausblick erforderlich."
    celine["suggestion"] = {"scope": "outlook_only", "reason": "Probezeit endete am 31.10.2025"}
    celine["dialog_date"] = "2025-11-03"
    celine["outlook"]["performance_goals"][0]["title"] = "Fachprozess selbständig bearbeiten"
    ...
    david["suggestion"] = {"scope": "none", "reason": "Pensionierung im ersten Halbjahr"}

    eva = employee("700005", "Eva", "Bühler", position="Teamleiterin")
    eva["suggestion"] = {"scope": "review_only", "reason": "Interner Übertritt per 30.09.2025; abschliessende Standortbestimmung empfohlen"}
